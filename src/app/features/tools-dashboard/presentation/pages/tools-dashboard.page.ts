      ...
      <div class="w-full max-w-6xl">
          ...
          <div class="flex-1 sm:flex-none relative">
            ...
            >
              @for (category of facade.categories; track category.value) {
                <option [value]="category.value" class="dark:bg-slate-800">
                  {{ category.label }}
                </option>
              }
            </select>
            <!-- Custom arrow -->
            <span
              class="absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400 dark:text-gray-500"
            >
              <svg
                class="w-4 h-4"
                viewBox="0 0 24 24"
        ...
        @if (facade.isLoading()) {
          <div class="text-center py-12">
            <div
              class="w-8 h-8 border-3 border-gray-200 dark:border-gray-700 border-t-emerald-500 dark:border-t-emerald-400 rounded-full animate-spin mx-auto mb-4"
            ></div>
          ...
          <div class="text-center py-12">
            ...
            <p class="mt-4 text-gray-600 dark:text-gray-300 font-medium">
